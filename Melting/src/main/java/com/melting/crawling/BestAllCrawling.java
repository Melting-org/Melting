...
public class BestAllCrawling {
	...
	public static void main(String[] args) throws Exception {
		...
		String pp_url = "https://www.ppomppu.co.kr/hot.php?category=2";
		String ru_url = "https://bbs.ruliweb.com/best/all/now?orderby=readcount&range=24h";
		String iv_url = "https://www.inven.co.kr/board/webzine/2097?my=chu"; 
		...
		for(int i=1; i<=n; i++) {	
			...
			title[i-1] = driver.findElement(By.xpath("//*[@id=\"container\"]/div/section[1]/article[1]/div[3]/ul[1]/li["+i+"]/a/div[2]/p")).getText();
			...
			comment[i-1] = driver.findElement(By.xpath("//*[@id=\"container\"]/div/section[1]/article[1]/div[3]/ul[1]/li["+1+"]/a/div[2]/span")).getText();
		...
		for (int i=0; i<n; i++) {
			...
			System.out.println("fmLink : " + fmLink[i]);
			System.out.println("fmCategory : " + fmCategory[i]);
